...
- Aumentar las capacidades de configuración de el shell y terminal de Ubuntu.
...
En este pequeño instructivo su pudo mostrar como actualizar nuestra terminal por defecto en *Ubuntu* instalando una nuea llamada *Terminator*. Esta terminal nos permite dividir la ventana principal en subventanas además de la opción de agrupar las ventanas para realizar un *Broadcast* entre ellas.

Por último, pudimos ver como instalando la shell *ZSH* y el programa *oh-my-zsh* acompañado de otros paquetes de fuentes como *Powerline* y *Nerd Fonts*, lográbamos configurar el prompt de nuestra terminal dándole un aspecto más atractivo que nos permitiera echarles más ganas durante nuestras horas de trabajo. 
